...
int main()
{
    window w = open_window("Animation Test", 1250, 720);
    ...
    animation_script dance_script = load_animation_script("WalkingScript", "frogAnimation.txt");
    ...
    while( not quit_requested() )
    {
        ...
        {
            assign_animation(test, "WalkLeft");
        }
        else if (key_typed(RIGHT_KEY))
        {
            assign_animation(test, "WalkRight");
        }
